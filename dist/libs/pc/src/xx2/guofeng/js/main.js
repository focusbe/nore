...
define(function (require, exports, module) {
    ...
    var MAIN = (function () {
        ...
        $maskbg = $('#maskbg'), $popup = $('#popup'), $regIframe = $('#reg_iframe'), $popupReg = $('#popup_reg'), // 弹层: 注册
        ...
        return {
            ...
            bindEvent: function () {
                ...
                $('body').on('click', '.J_player_big', function (e) {
                    var _this = $(this), _id = _this.attr('data-id'), _pic = _this.attr('data-big');
                    $playerPopup.show();
