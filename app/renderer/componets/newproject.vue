<template>
    <Modal
        ...
        <Form ref="form" :model="projectInfo" label-position="left" :label-width="100" :rules="projectRules">
            ...
            this.$refs["form"].validate(valid => {
                if (valid) {
                    ...
                    newproject.create(function(){
                        ...
                        Socket.sendTo('MAIN','open',{tag:'project_edit',hash:'#/project/edit',search:'?actname='+self.projectInfo.actname});
