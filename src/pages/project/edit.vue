...
<div class="page_wrap">
    ...
    <div class="right_area">
        <styles-panel @onChange="onCurStylesChange" v-if="styleOptions" :options="styleOptions" :optionsValue="curStyles" title="样式布局"></styles-panel>
        <br>
        <my-options @onChange="onCurPropsChange" v-if="propOptions" :options="propOptions" :optionsValue="curProps" title="组件参数"></my-options>
        <br>
    </div>
    <div v-show="dragover" class="dragover">
