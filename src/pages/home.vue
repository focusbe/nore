<template id="">
    <div class="page_wrap">
        <ul class="project_list">
            <li v-for="(item,key) in projectList">
            ...
            <li>
                <Button type="primary" @click="showprojectadd"><Icon type="plus-round" :size="25"></Icon></Button>
            </li>
        </ul>
...
export default {
    ...
    methods:{
        ...
        projectEdit:function(id){
            ...
            Socket.sendTo('MAIN','open',{tag:'project_edit_'+id,hash:'#/project/edit?actname='+id});
        }
    }
};
</script>
